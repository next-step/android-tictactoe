...
class TictectoeRuleTest {
    ...
    fun `상단 가로줄 모두 player1이 차지할 경우 승리한 자는 player1이다`() {
        ...
        // then : 게임상태는 GameStatus.PLAYER1_WIN이다.
...
//        val board = mutableListOf(Cell.NONE,
//            Cell.PLAYER2, Cell.PLAYER1, Cell.PLAYER1,
//            Cell.PLAYER1, Cell.PLAYER2, Cell.PLAYER2,
//            Cell.PLAYER2, Cell.PLAYER1, Cell.PLAYER1,)
//
//        // when : 게임에 승리 조건에 보드를 넣는다.
...
//
//        // then : None이 반환된다.
//        assertThat(actual).isEqualTo(Cell.NONE)
//    }
//
//    @Test
...
//
//        // then : Player1이 반환된다.
//        assertThat(actual).isEqualTo(Cell.PLAYER1)
//    }
//
//    @Test
...
//        val board = mutableListOf(Cell.NONE,
//            Cell.PLAYER2, Cell.NONE, Cell.NONE,
//            Cell.PLAYER2, Cell.NONE, Cell.NONE,
//            Cell.PLAYER2, Cell.NONE, Cell.NONE,)
//
//        // when : 게임에 승리 조건에 보드를 넣는다.
...
//
//        // then : Player2이 반환된다.
//        assertThat(actual).isEqualTo(Cell.PLAYER2)
//    }
//
//    @Test
...
//        val board = mutableListOf(Cell.NONE,
//            Cell.NONE, Cell.PLAYER2, Cell.NONE,
//            Cell.NONE, Cell.PLAYER2, Cell.NONE,
//            Cell.NONE, Cell.PLAYER2, Cell.NONE,)
//
//        // when : 게임에 승리 조건에 보드를 넣는다.
...
//        val board = mutableListOf(Cell.NONE,
//            Cell.NONE, Cell.NONE, Cell.PLAYER2,
//            Cell.NONE, Cell.NONE, Cell.PLAYER2,
//            Cell.NONE, Cell.NONE, Cell.PLAYER2,)
//
//        // when : 게임에 승리 조건에 보드를 넣는다.
